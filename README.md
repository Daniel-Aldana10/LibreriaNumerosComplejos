...
El proyecto presentado a continuación tiene como objetivo el de ser una herramienta para poder realizar operaciones básicas con los números complejos.
# Instalación y requisitos 
No hay que instalar librerías adicionales, ya que se usan las que ya están en Python, solo se necesita un programa como PyCharm, Visual Studio, para poder ver el desarrollo y ejecución del proyecto.
...
En las operaciones no mencionadas no se tuvo em mente, un juicio para poner o no determinada operación con unos números específicos.
# Autor
